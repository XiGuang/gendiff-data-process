...
class LineageAndEditTests(unittest.TestCase):
    ...
    def test_ring_changes_do_not_create_false_point_actions(self) -> None:
        ...
        self.assertEqual(sequence.stages[0].layers[0].point_lineage_ids, sequence.stages[1].layers[0].point_lineage_ids)
    ...
    def test_tampered_edit_hash_fails_closed(self) -> None:
        ...
        with self.assertRaises(CanonicalizationError) as caught:
            apply_canonical_edit(sequence.stages[0], tampered, self.bundle.canonicalizer)
    ...
    def test_symmetric_layer_split_uses_stable_lowest_target(self) -> None:
        source = CanonicalLayer(0, 0, 1000, ((0, 0), (4000, 0), (4000, 2000), (0, 2000)), "s")
        left = CanonicalLayer(0, 0, 1000, ((0, 0), (2000, 0), (2000, 2000), (0, 2000)), "l")
        right = CanonicalLayer(1, 0, 1000, ((2000, 0), (4000, 0), (4000, 2000), (2000, 2000)), "r")
        results = [match_layers((source,), (left, right), self.bundle.canonicalizer) for _ in range(100)]
